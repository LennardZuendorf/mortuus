...
import tech.ignitr.archive.model.Zombie;
...
public class App {
    ...
    private static void showMenu() {
        String menuItems[] = { "", "(1)\t SuperZombie anlegen",
                "(2)\t Drei Zombie-Anhaenger generieren",
                "(3)\t Daten des SuperZombies ausgeben",
                "(4)\t Daten aller Zombie-Anhaenger ausgeben",
                "(5)\t Die Nacht durchstreifen",
                "(6)\t Beenden" };
        System.out.println("\nZombies Version 1.1\n");
